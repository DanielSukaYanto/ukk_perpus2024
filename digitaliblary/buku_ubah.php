...
<div class="card">
    ...
    <div class="row">
        <div class="col-md-12">
            <form method="post">
                <!-- Mengambil nilai dari masing masing input form dengan menggunakan method post-->
                <?php
                    $id = $_GET['id'];
                ...
                ?>
                <!-- $query menjalankan query sql dan untuk update data lama ke data baru ke dalam tble baru dengan nilai 
                yang ada di form.-->
                <div class="row mb-3">
